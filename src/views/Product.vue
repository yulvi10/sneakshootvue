            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="product-pic-zoom">
                  <img class="product-big-img" :src="image_big" alt />
                </div>
                <div class="product-thumbs">
                  <carousel class="product-thumbs-track ps-slider" :nav="false" :dots="false">
                    <div
                      ...
                      :class="thumbs[0] == image_big ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[1] == image_big ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[2] == image_big ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[3] == image_big ? 'active' : ''"
                    >
...
import RelatedProductStore from "@/components/RelatedProductStore.vue";
